<#
	.SYNOPSIS
		Installs the VMDeploy.Orchestrator Module from github
		
	.DESCRIPTION
		This script installs the VMDeploy.Orchestrator Module from github.
