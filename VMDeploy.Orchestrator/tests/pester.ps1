...
Remove-Module VMDeploy.Orchestrator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\VMDeploy.Orchestrator.psd1"
Import-Module "$PSScriptRoot\..\VMDeploy.Orchestrator.psm1" -Force
